...
def is_mel(name, email):
    ...
    >>> is_mel('Mel Melitpolski', 'info@ubermelon.com')
    True

    >>> is_mel('John Smith', 'mel@ubermelon.com')
    True
    """
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type': 'nerf balls'}, {'type': 'frisbee'},
    ...      {'type': 'nerf balls'}, {'type': 'nerf balls'}])
    ('nerf balls', 'frisbee')

    >>> most_and_least_common_type([{'type': 'nerf balls'}])
    ('nerf balls', 'nerf balls')
